    ...
    <div class="box-inner pb-0">
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-6">
                ...
                <img class="case-item__icon" src="<?php echo e(asset('assets/icons/icon-design.svg')); ?>" />
                    <div>
            ...
            <div class="col-12 col-lg-6">
                <div class="case-item box box__second">
                <img class="case-item__icon" src="<?php echo e(asset('assets/icons/icon-dev.svg')); ?>" />
                    <div>
            ...
            <div class="col-12 col-lg-6">
                <div class="case-item box box__second">
                <img class="case-item__icon" src="<?php echo e(asset('assets/icons/icon-app.svg')); ?>" />
                    <div>
            ...
            <div class="col-12 col-lg-6">
                <div class="case-item box box__second">
                <img class="case-item__icon" src="<?php echo e(asset('assets/icons/icon-photo.svg')); ?>" />
                    <div>
        ...
        <div class="swiper-container js-carousel-review">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide review-item">
                    <svg class="avatar avatar--80" viewBox="0 0 84 84">
                        <g class="avatar__hexagon">
                            <image xlink:href="<?php echo e(asset('assets/img/Avatar-2.svg')); ?>" height="100%" width="100%" />
                        </g>
                    </svg>
                ...
                <div class="swiper-slide review-item">
                    <svg class="avatar avatar--80" viewBox="0 0 84 84">
                        <g class="avatar__hexagon">
                            <image xlink:href="<?php echo e(asset('assets/img/Avatar-3.svg')); ?>" height="100%" width="100%" />
                        </g>
                    </svg>
                ...
                <div class="swiper-slide review-item">
                    <svg class="avatar avatar--80" viewBox="0 0 84 84">
                        <g class="avatar__hexagon">
                            <image xlink:href="<?php echo e(asset('assets/img/Avatar-4.svg')); ?>" height="100%" width="100%" />
                        </g>
                    </svg>
                ...
                <div class="swiper-slide review-item">
                    <svg class="avatar avatar--80" viewBox="0 0 84 84">
                        <g class="avatar__hexagon">
                            <image xlink:href="<?php echo e(asset('assets/img/Avatar-5.svg')); ?>" height="100%" width="100%" />
                        </g>
                    </svg>
        ...
        <div class="swiper-container js-carousel-clients">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a href="#"><img src="<?php echo e(asset('assets/img/logo-partner.svg')); ?>" alt="Logo" /></a>
                </div>
...
<?php echo $__env->make('layouts.frontend.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Desktop\github-learn\resources\views/layouts/frontend/about.blade.php ENDPATH**/ ?>