    ...
    <div class="pb-0">
        <div class="row">
            <div class="col-12 col-lg-6">
                <h2 class="title title--h3"><img class="title-icon" src="<?php echo e(asset('assets/icons/icon-education.svg')); ?>" /> Education</h2>
                <div class="timeline">
                    <!-- Item -->
            ...
            <div class="col-12 col-lg-6">
                <h2 class="title title--h3"><img class="title-icon" src="<?php echo e(asset('assets/icons/icon-experience.svg')); ?>" /> Experience</h2>
                <div class="timeline">
                    <!-- Item -->
                    <article class="timeline__item">
...
<?php echo $__env->make('layouts.frontend.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Desktop\github-learn\resources\views/layouts/frontend/resume.blade.php ENDPATH**/ ?>