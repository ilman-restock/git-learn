...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('backend/css/font-awesome.css')); ?>">
        <!-- ico-font-->
    ...
    <body>
        ...
        <div class="row">
            <div class="col-xl-7 order-1"><img class="bg-img-cover bg-center" src="<?php echo e(asset('backend/images/login/1.jpg')); ?>" alt="looginpage"></div>
            <div class="col-xl-5 p-0">
                <div class="login-card">
                    <div>
                        <div><a class="logo text-start" href="index.html"><img class="img-fluid for-light" src="<?php echo e(asset('backend/images/logo/logo.png')); ?>" alt="looginpage"><img class="img-fluid for-dark" src="<?php echo e(asset('backend/images/logo/logo_dark.png')); ?>" alt="looginpage"></a></div>
                        <div class="login-main"> 
                            <form class="theme-form" method="POST" action="<?php echo e(route('login.admin')); ?>">
                                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\Admin\Desktop\github-learn\resources\views/backend/auth/login.blade.php ENDPATH**/ ?>