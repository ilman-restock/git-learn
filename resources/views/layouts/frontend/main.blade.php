                ...
                <aside class="col-12 col-md-12 col-xl-3">
                    <div class="sidebar box shadow pb-0 sticky-column">
                        <svg class="avatar avatar--180" viewBox="0 0 188 188">
                            <g class="avatar__box">
                                <image xlink:href="{{ asset('assets/img/Avatar-1.svg') }}" height="100%" width="100%" />
                            </g>
                        </svg>
		        ...
		        <div class="col-12 col-md-12 col-xl-9">
				    <div class="box shadow pb-0">
                        ...
                        <div class="inner-menu js-menu">
                            <ul class="nav">
                                <li class="nav__item"><a class="{{ $title == 'About' ? 'active' : '' }}" href="{{ route('about.front') }}">About</a></li>
                                <li class="nav__item"><a class="{{ $title == 'Resume' ? 'active' : '' }}" href="{{ route('resume.front') }}">Resume</a></li>
                                <li class="nav__item"><a class="{{ $title == 'Portfolio' ? 'active' : '' }}" href="{{ route('portfolio.front') }}">Portfolio</a></li>
                                <li class="nav__item"><a class="{{ $title == 'Blog' ? 'active' : '' }}" href="{{ route('blog.front') }}">Blog</a></li>
                                <li class="nav__item"><a class="{{ $title == 'Contact' ? 'active' : '' }}" href="{{ route('contact.front') }}">Contact</a></li>
                            </ul>
                        </div>
